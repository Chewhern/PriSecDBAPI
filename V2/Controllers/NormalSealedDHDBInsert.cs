...
namespace PriSecDBAPI.Controllers
{
    ...
    [ApiController]
    public class NormalSealedDHDBInsert : ControllerBase
    {
                            ...
                            if (ClientCheckConnection == true)
                            {
                                ...
                                if (DateTime.Compare(MyUTC8DateTime, DatabaseExpirationTime) <= 0)
                                {
                                    ...
                                    catch
                                    {
                                        ...
                                        SodiumSecureMemory.SecureClearString(MyDBInsertModel.MyDBCredentialModel.SealedDBName);
                                        ...
                                        SodiumSecureMemory.SecureClearString(MyDBInsertModel.MyDBCredentialModel.SealedDBUserName);
                                        ...
                                        SodiumSecureMemory.SecureClearString(MyDBInsertModel.MyDBCredentialModel.SealedDBUserPassword);
                                        ...
                                        SodiumSecureMemory.SecureClearString(MyDBInsertModel.MyDBCredentialModel.SealedSessionID);
